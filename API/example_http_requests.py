...
response_3_2 = requests.get('http://localhost:8080/create_metric/1')
...
response_3_1 = requests.post('http://localhost:8080/metric/1', json= data)
print(response_3_1, response_3_1.json())

time.sleep(1)
"""Статус воркера для расчета метрики модели 1"""
response_3_2_2 = requests.post('http://localhost:8080/results/'+str(response_3_1.json()[10:]))
print(response_3_2_2, response_3_2_2.json())

"""GET метрики модели 1"""
response_3_2 = requests.get('http://localhost:8080/get_metric/1')
print(response_3_2, response_3_2.json())

"""DELETE метрики модели 1, если она уже есть"""
response_3_2 = requests.get('http://localhost:8080/delete_metric/1')
print(response_3_2, response_3_2.json())
...
response_3_2 = requests.get('http://localhost:8080/create_metric/2')
print(response_3_2, response_3_2.json())
...
data = {'payload': payload}
response_3_1 = requests.post('http://localhost:8080/metric/2', json= data)
print(response_3_1, response_3_1.json())
...
response_3_2 = requests.get('http://localhost:8080/get_metric/2')
print(response_3_2, response_3_2.json())

"""DELETE метрики модели 2, если она уже есть"""
response_3_2 = requests.get('http://localhost:8080/delete_metric/2')
print(response_3_2, response_3_2.json())
